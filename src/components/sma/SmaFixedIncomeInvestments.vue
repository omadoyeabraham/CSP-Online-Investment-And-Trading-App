  ...
  <v-layout class="" row wrap>
    ...
    <v-flex xs12 sm8>
      ...
      <v-card class="p10 red--text font-size-11 font-weight-bold">
          You have {{numberOfInvestments}} fixed income investment(s)
      </v-card>
      <v-data-table
          ...
          <ul
            ...
            <li class="list-group-item font-size-12 white--text">
             ...
             <li class="list-group-item font-size-12 white--text">
              ...
              <span v-if="selectedInvestment.status === 'RUNNING'"
              class="ml-auto font-weight-bold green--text">{{selectedInvestment.status}}</span>
              <span v-if="selectedInvestment.status === 'TERMINATED'"
              class="ml-auto font-weight-bold red--text">{{selectedInvestment.status}}</span>
            </li>
            <li class="list-group-item font-size-12 white--text">
...
export default
{
  ...
  props: ['currency', 'investments', 'investmentType', 'investmentTitle', 'showTotalValue'],
