...
const getters = {
  ...
  newsFeed: state => {
    ...
    state.newsFeed = state.newsFeed ? state.newsFeed : [];
  ...
  foreignExchange: state => {
    const data = [
      {
        label: "NGN/USD",
        value: state.foreignExchange.USDRate,
        imgClass: "usd-flag"
      },
      {
        label: "NGN/GBP",
        value: state.foreignExchange.GBPRate,
        imgClass: "gbp-flag"
      },
      {
        label: "NGN/EUR",
        value: state.foreignExchange.EURRate,
        imgClass: "eur-flag"
      },
      {
        label: "NGN/CNY",
        value: state.foreignExchange.CNYRate,
        imgClass: "cny-flag"
      },
      {
        label: "NGN/AUD",
        value: state.foreignExchange.AUDRate,
        imgClass: "aud-flag"
      }
    ];
    return data;
